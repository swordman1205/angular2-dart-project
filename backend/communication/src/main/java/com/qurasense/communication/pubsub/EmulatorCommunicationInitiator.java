...
@Component
@Profile("emulator")
public class EmulatorCommunicationInitiator {
    ...
    private void createTopicAndSubscriber() {
        ...
        try {
            ...
            ProjectTopicName topicName = ProjectTopicName.of(defaultProjectId,
            ...
            ProjectSubscriptionName subscriptionName = ProjectSubscriptionName.of(defaultProjectId,
