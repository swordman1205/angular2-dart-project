package com.qurasense.axon.datastore.utils;
...
public class DataStoreUtils {
    ...
    public static Value getValue(Instant instant) {
        return Objects.nonNull(instant) ? TimestampValue.of(Timestamp.of(Date.from(instant))) : NullValue.of();
    }
